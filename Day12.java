...
public class Day12 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Size of group 0: " + countNotVisitedChildren("0")); // 130
		
		int groupCnt1 = 1 + nodes.keySet().stream().map(nodeName -> countNotVisitedChildren(nodeName)).collect(Collectors.summingInt(s -> s > 0 ? 1 :0));
		
		System.out.println("Group count: " + groupCnt1); // 189

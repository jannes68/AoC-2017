...
Before you're ready to help them, you need to make sure your information is correct. What is the name of the bottom program?	
	*/
	...
	public static void main(String[] args) {
		...
		String rootName = allPgmMap.values().stream().filter(pgm -> pgm.getParent() == null).findFirst().get().getName();
	...
	static class Pgm {
		...
		List<String> subPgm;
		Pgm	parent = null;
		List<Pgm> childs = new ArrayList<>();
		
		public Pgm(String str) {
			String[] fsplit = str.split("->");
			if(fsplit.length==2) {
				String[] subPgmSplit = fsplit[1].split(",");
				subPgm = Arrays.asList(subPgmSplit).stream().map(s -> s.trim() ).collect(Collectors.toList());
			} else {
				subPgm = Collections.emptyList();
			}
			String[] nameWeightSplit = fsplit[0].split(" ");
			name = nameWeightSplit[0];
		...
		public String toString() {
			return "Pgm [name=" + name + ", weight=" + weight + ", subPgm=" + subPgm + ", parent=" + (parent != null ? parent.getName() : "null")
					+ "]";
		}
		...
		public Pgm getParent() {
			return parent;
		}

		public Pgm setParent(Pgm parent) {
			this.parent = parent;
			return this;
		}

		public List<Pgm> getChilds() {
			return childs;
		}

		public void setChilds(List<Pgm> childs) {
			this.childs = childs;
		}

		public List<String> getSubPgm() {
			return subPgm;
		}

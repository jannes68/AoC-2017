...
--- Day 6: Memory Reallocation ---
	...
	*/
	...
	public static void main(String[] args) {
			while(!isCurrentBlockPatternUsed()){
				
			}
	}

	static boolean isCurrentBlockPatternUsed() {
		return banksPatternUsed.contains(getBlocksHash());
	}
	...
	static long getBlocksHash() {
		return Arrays.hashCode(banks);
	}
	
	static Set<Integer> banksPatternUsed = new HashSet<>();
	
	static int[] banks = { 4,	1,	15,	12,	0,	9,	9,	5,	5,	8,	7,	3,	14,	5,	12,	3, };

...
-- Day 10: Knot Hash ---
	...
	The hash these programs are implementing isn't very strong, but you decide to help them anyway. You make a mental note to remind the Elves later not to invent their own cryptographic functions.
...
--- Part Two ---
	...
	convert characters to bytes using their ASCII codes. This will allow you to handle arbitrary ASCII strings, 
	...
	*/
	...
	public static void main(String[] args) {
		...
		//D4F76BDCBF838F84
		int bits = hashRows.stream().collect(Collectors.summingInt(hex -> countOnes(hex)));
		System.out.println("bits: " + bits);
		
		
	}
	
	static int countOnes(String hex) {
		return 
				Long.bitCount(Long.parseLong(hex.substring(0,8), 16)) +
				Long.bitCount(Long.parseLong(hex.substring(8,16), 16))+
				Long.bitCount(Long.parseLong(hex.substring(16,24), 16)) +
				Long.bitCount(Long.parseLong(hex.substring(24,32), 16));
	}
}
